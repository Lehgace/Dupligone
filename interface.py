...
class HomePage(ctk.CTkFrame):
    ...
    def __init__(self, parent, controller):
        ...
        heading_label = ctk.CTkLabel(self, text='Dupligone!', font=('Roboto',45,'bold'))
...
class UploadPage(ctk.CTkFrame):
    ...
    def __init__(self, parent, controller):
        ...
        main_menu_label = ctk.CTkLabel(self, text='Upload Content to Workspace', font=('Roboto',20))
        ...
        # Create Exit button    
        exit_button = ctk.CTkButton(self, text='Exit', font=('Roboto',15), command=exit)
        ...
        goto_search_button = ctk.CTkButton(self, text='Begin Search', font=('Roboto',30), command=gotoSearch)
...
class SearchPage(ctk.CTkFrame):
    ...
    def __init__(self, parent, controller):
        ...
        duplicates_label = ctk.CTkLabel(header_frame, text='Duplicates', font=('Roboto',22, 'bold'))
        duplicates_label.pack(fill="x",side='left',padx=200)
        image_preview_label = ctk.CTkLabel(header_frame, text='Image Preview', font=('Roboto',22, 'bold'))
        ...
        # Function to call for image preview
        preview_image = ctk.CTkImage(Image.open(r"C:\Users\theun\OneDrive\Documents\Dupligone\TestImages\AC2.jpg"), size=(500,350))
        preview_image_button = ctk.CTkButton(right_frame, image=preview_image, width=500, height=350, text='AC2.jpg', font=('Roboto',15), compound="top", fg_color="transparent", hover=False)
        ...
        class CompareWindow(ctk.CTkToplevel):
            def __init__(self, *args, **kwargs):
                ...
                # Header Label for Dupligone Logo
                compare_head_label = ctk.CTkLabel(self, text='Preview', font=('Roboto',20,'bold'))
                ...
                left_image = ctk.CTkImage(Image.open(r"C:\Users\theun\OneDrive\Documents\Dupligone\TestImages\AC1.jpg"), size=(550,400))
                left_image_button = ctk.CTkButton(left_compare_frame, image=left_image, width=550, height=400, text='AC1.jpg', font=('Roboto',15), compound="top", fg_color="transparent", hover=False)
                ...
                right_image = ctk.CTkImage(Image.open(r"C:\Users\theun\OneDrive\Documents\Dupligone\TestImages\AC2.jpg"), size=(550,400))
                right_image_button = ctk.CTkButton(right_compare_frame, image=right_image, width=550, height=400, text='AC2.jpg', font=('Roboto',15), compound="top", fg_color="transparent", hover=False)
        ...
        rename_button.configure(command=lambda: open_renamelevel(self)) # test with Kirby photo
        ...
        compare_button = ctk.CTkButton(right_frame, text='Compare Related', font=('Roboto',15), fg_color="#1338BE") # test with AC1 and AC2
        ...
        # Exit button 
        exit_button = ctk.CTkButton(bottom_frame, text='Exit', font=('Roboto', 15), command=exit)
